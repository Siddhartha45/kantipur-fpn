(function($) {
	...
	function init(this_sel) {
		...
		template += '<button type = "button"  class = "andp-prev andp-change-months"> <i class="fa-solid fa-play"></i> </button>';
		template += '<select class = "andp-month-select"> </select>';
		template += '<select class = "andp-year-select"> </select>';
		template += '<button type = "button" class = "andp-next andp-change-months"> <i class="fa-solid fa-play"></i> </button> ';
		template += '</div>';
