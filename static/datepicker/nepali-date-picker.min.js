(function (e) {
    ...
    function n(t) {
        ...
        var n =
            '<div class="andp-datepicker-container" data-cal_id="' + y + '" >';
        for (
            n += '<div class = "andp-header">',
                n +=
                    '<button type = "button"  class = "andp-prev andp-change-months"> <i class="fa-solid fa-play"></i> </button>',
                n += '<select class = "andp-month-select"> </select>',
                n += '<select class = "andp-year-select"> </select>',
                n +=
                    '<button type = "button" class = "andp-next andp-change-months"> <i class="fa-solid fa-play"></i> </button> ',
                n += "</div>",
        ...
        l(),
            e('.andp-datepicker-container[data-cal_id="' + y + '"]').addClass(
                "open"
            ),
            s();
    }
    ...
    function l() {
        ...
        for (i = 1; i <= 42; i++) {
            ...
            if ((1 == n && (append_html += '<div class="andp-column">'), i < t))
                ...
                (append_html += '<div  class="old-dates"> ' + o + "</div>"),
                    o++;
    ...
    function p(a, n = !1) {
        a = t(a);
        var i = b.indexOf(a),
            s = e('.andp-datepicker-container[data-cal_id="' + y + '"]'),
            l = s.find('.day[data-date="' + a + '"]');
        n
    ...
    (e.fn.nepaliDatePicker = function () {
        navigator.platform.toUpperCase().indexOf("MAC") >= 0 && (T = "mac"),
                ...
                if (
                    ...
                    if (i > 0)
                        if (1 == i)
                            ...
                            older_date = e(
                                'input.andp-hidden-dates[data-cal_id="' +
                                    y +
                                    '"]'
                            );
            ...
            _.on(
                "change",
                ".andp-month-select, .andp-year-select",
                function () {
                    l();
                }
            );
        ...
        _.on(
            ...
            function (t) {
                (selected_day = e(this).text()),
                    (selected_date = e(this).data("date"));
                var n = e(
                    '.andp-datepicker-container[data-cal_id="' + y + '"]'
                );
                if (E)
                    (b = []),
        ...
        _.on(
            "click",
            ".andp-datepicker-container.open .apply-date",
            function () {
                a();
            }
        );
